...
version_ns = {}
with open(pjoin(here, 'ExternalAuthenticator', '_version.py')) as f:
    exec(f.read(), {}, version_ns)


setup_args = dict(
    name                = 'ExternalAuthenticator',
    packages            = ['ExternalAuthenticator'],
    version             = version_ns['__version__'],
    description         = "ExternalAuthenticator: Authenticate JupyterHub users with an external authentication service using an identical cookie secret.",
    ...
    entry_points={
        'jupyterhub.authenticators': [
            'external_authenticator = ExternalAuthenticator:ExternalAuthenticator',
        ],
    },
    classifiers         = [
